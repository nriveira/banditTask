...
sub = 8
data_loc = r'/Users/nick/Projects/ODoherty/vince_data/csv'
...
#%%
# Group Aggregation
group_string = '/group_data.csv'
group_data_loc = data_loc+group_string
# Import the group and individual data
group_data = pd.read_csv(group_data_loc, 
                         true_values=['early', 'True'], 
                         false_values=['late', 'False'])

#group_data.groupby(['subID', 'RT']).plot(figsize=(24, 24), subplots=True, sharex=True, layout=(11,2), xlabel='Trial Number')
group_data.groupby(['subID', 'block', 'blockTrialNo']).hist(figsize=(24, 24))